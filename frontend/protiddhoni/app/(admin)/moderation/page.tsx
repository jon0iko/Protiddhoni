...
import { CheckCircle, XCircle, Eye, Clock, User, Loader2, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">কন্টেন্ট পর্যালোচনা</h1>
          <p className="text-gray-600">{pendingContents.length}টি রচনা পর্যালোচনার জন্য অপেক্ষামান</p>
        </div>
        ...
        {pendingContents.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-lg border border-gray-200">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">সব রচনা পর্যালোচিত</h3>
            <p className="text-gray-500">এই মুহূর্তে পর্যালোচনার জন্য কোনো রচনা নেই।</p>
          </div>
        ) : (
              ...
              <div key={content.id} className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    {content.excerpt && (
                      <p className="text-gray-600 mb-3 line-clamp-2">{content.excerpt}</p>
                    )}
                    <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                      <div className="flex items-center gap-1">
                        <User className="w-4 h-4" />
                        <span>{content.author?.full_name || content.author?.username}</span>
                      </div>
                      <div className="flex items-center gap-1">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900">রচনা প্রত্যাখ্যান</h3>
            </div>
            <p className="text-gray-600 mb-4">প্রত্যাখ্যানের কারণ লিখুন:</p>
            <textarea
