        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <h1 className="font-semibold text-gray-900 dark:text-gray-100 bengali-text">
                ...
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg py-1 z-50">
                    <button
                      ...
                      className="w-full px-4 py-2 text-left hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-2 bengali-text"
                    >
                      <FolderOpen className="h-4 w-4" />
                      খসড়া দেখুন
                    </button>
