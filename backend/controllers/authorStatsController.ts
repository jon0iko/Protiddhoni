 ...
 */
const getAuthorStats = async (req: Request, res: Response) => {
 ...
 * Admin only
 */
const refreshAuthorStats = async (req: Request, res: Response) => {
  try {
    const supabase = db.getClient();
...
export { getAuthorStats, getRecentActivity, refreshAuthorStats };
