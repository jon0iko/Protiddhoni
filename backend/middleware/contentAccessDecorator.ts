import type { AuthUser, AccessResult } from '../types';
...
class ContentAccess {
    async checkAccess(user?: any, contentId?: string): Promise<AccessResult> {
        return { granted: true };
    }
}
...
class PaywallDecorator extends ContentAccess {
    public wrappedAccess: ContentAccess;
    protected db: any;

    constructor(contentAccess: ContentAccess, db: any) {
        super();
...
export { ContentAccess, PaywallDecorator };
